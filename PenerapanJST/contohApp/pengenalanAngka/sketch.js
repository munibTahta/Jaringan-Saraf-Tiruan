...
function setup() {
  ...
  var clearButton = createButton('bersihkan');
  ...
  // Save the model
  var saveButton = createButton('simpan model');
...
function draw() {
  ...
  drawImage(traindata, ux, 16, 2, 'Pelatihan/training');
  ...
  var status = 'performa: ' + nf(totalCorrect / totalGuesses, 0, 2);
  status += '<br>';
